...
object SecureSharedPref : SharedPreferences {
    ...
    private val keyChain: SharedPrefsBackedKeyChain =
        SharedPrefsBackedKeyChain(SkeletonApplication.getContext(), CryptoConfig.KEY_256)
    ...
    init {
        SoLoader.init(SkeletonApplication.getContext(), false)
    }
